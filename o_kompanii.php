...
<h1>О компании <?php echo $main_name; ?></h1>
			Официальный представитель на территории Российской Федерации компания "База Знаний"
			...
			Работаем по индивидуальному договору возмездного оказания услуг или <a href='http://<?php echo $main_name; ?>/dogovor.php'>публичной оферте</a><br>
			ИНН/КПП: 7813239461/781301001<br>
			БИК 042202603<br>
			ОГРН 1157847438539<br><br>
			...
			<a href='http://<?php echo $main_name; ?>/consult.php'>Отзывы за последние годы на сайте</a><br><br>
