...
switch ($vibor_niz_case) {
    case 1:
        $vibor_niz = 'Наши авторы в ходе выполнения дипломной работы для вас:<br>
подберут необходимую литературу;<br>
проведут теоретический анализ изучаемого объекта;<br>
сопоставят полученные выводы с данными практических исследований;<br>
согласно требованиям ВУЗа и ГОСТа к работе оформят приложения к диплому и список литературных источников;<br>
проведут доработку проекта в соответствии с рецензией научного руководителя;<br>
подготовят студента к защите (мы заинтересованы, чтобы она прошла успешно!). <br>    
';
        break;
    case 2:
        $vibor_niz = 'Не рискуйте деньгами и временем – заказывайте выполнение дипломной работы у нас! <br> 
        Делая дипломы на заказ, мы предлагаем студентам только уникальные работы и получаем отличные отзывы. <br> 
        Мы не пользуемся услугами «разовых» или непроверенных авторов. <br> 
        Работы выполняются исключительно преподавателями или аспирантами профильных специальностей на высоком уровне.<br> 
Свяжитесь с нами уже сегодня, чтобы быть готовым к защите дипломной работы завтра!<br> 
';
        break;
    case 3:
        $vibor_niz = 'Ответственное отношение к написанию дипломной работы нашими авторами позволит <br> 
        Вам получить положительную оценку, а, следовательно, и хорошие перспективы <br> 
        для трудоустройства или продвижения по карьерной лестнице.<br>  
        Выполним авторские дипломные работы на заказ качественно, доработка Бесплатно! <br> 
        И по доступной для студентов цене.<br> 
        Теперь у Вас будет значительно больше времени и сил на подготовку <br> 
        к защите дипломной работы. <br>
';
        break;
