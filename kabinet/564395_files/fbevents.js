/*1476507855,,JIT Construction: v2624182,en_US*/
...
$(document).ready(function(){
	$('#link1').click(function(){
		...
		if($('#link1').text()=='Дополнительные сведения'){
			$('#link1').text('Открыть дополнительные сведения');
		}
		else{
			$('#link1').text('Дополнительные сведения');
		}
	});
});
$(document).ready(function(){
	$('#link3').click(function(){
		...
		if($('#link3').text()=='Дополнительные сведения'){
			$('#link3').text('Открыть дополнительные сведения');
		}
		else{
			$('#link3').text('Дополнительные сведения');
		}
	});
});
$(document).ready(function(){
	$('#link4').click(function(){
		if(jQuery.browser.msie && parseInt(jQuery.browser.version)==6){
			if($('#look4').css("display")=="block"){
				$('#look4').css("display", "none");
			}
			else{
				$('#look4').css("display", "block");
			}
		}
		else{
			$('#look4').toggle("slow");
		}
		if($('#link4').text()=='Дополнительные сведения'){
			$('#link4').text('Открыть дополнительные сведения');
		}
		else{
			$('#link4').text('Дополнительные сведения');
		}
	});
});
$(document).ready(function(){
	$('#link5').click(function(){
		if(jQuery.browser.msie && parseInt(jQuery.browser.version)==6){
			if($('#look5').css("display")=="block"){
				$('#look5').css("display", "none");
			}
			else{
				$('#look5').css("display", "block");
			}
		}
		else{
			$('#look5').toggle("slow");
		}
		if($('#link5').text()=='Дополнительные сведения'){
			$('#link5').text('Открыть дополнительные сведения');
		}
		else{
			$('#link5').text('Дополнительные сведения');
		}
	});
});
