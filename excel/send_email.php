...
if ( (int)$i >= (int)$count) {
    ...
    switch ($sub_1) {
        ...
        case 1:
            $sub_1_text = ' в ноябре-декабре за ';
            break;
        case 2:
            $sub_1_text = ' в конце ноября за ';
            break;
        case 3:
    ...
    switch ($sub_2) {
        case 1:
            $sub_2_text = ' Срочное выполнение без переплат';//' Нет аванса';
            break;
        case 2:
            $sub_2_text = ' Сделаем быстро без завышения цены';//' Без аванса';
            break;
        case 3:
