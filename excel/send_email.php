...
if ( (int)$i >= (int)$count) {
    ...
    switch ($sub_1) {
        ...
        case 1:
            $sub_1_text = ' в этом ноябре по ';
            break;
        case 2:
            $sub_1_text = ' уже сегодня по ';
            break;
        case 3:
    ...
    switch ($sub_2) {
        case 1:
            $sub_2_text = ' Платите, когда заказ будет выполнен!';//' Нет аванса';
            break;
        case 2:
            $sub_2_text = ' Вносите деньги по завершению работы!';//' Без аванса';
            break;
        case 3:
