...
if ( (int)$i >= (int)$count) {
    ...
    switch ($sub_1) {
        ...
        case 1:
            $sub_1_text = ' по новогодней цене за ';
            break;
        case 2:
            $sub_1_text = ' за новогоднюю стоимость ';
            break;
        case 3:
    ...
    switch ($sub_2) {
        case 1:
            $sub_2_text = ' В том числе срочные заказы';//' Нет аванса';
            break;
        case 2:
            $sub_2_text = ' Можно сделать в сжатые сроки';//' Без аванса';
            break;
        case 3:
