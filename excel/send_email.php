...
if ( (int)$i >= (int)$count) {
    ...
    switch ($sub_1) {
        ...
        case 1:
            $sub_1_text = ' от кандидатов за ';
            break;
        case 2:
            $sub_1_text = ' от кандидата за ';
            break;
        case 3:
    ...
    switch ($sub_2) {
        case 1:
            $sub_2_text = ' Без предоплат, срочность без наценок.';//' Нет аванса';
            break;
        case 2:
            $sub_2_text = ' Нет предоплаты, срочно и без наценки.';//' Без аванса';
            break;
        case 3:
